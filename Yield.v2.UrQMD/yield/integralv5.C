...
double Vol;
double lambdas=2;
double mu=4*alphas*B*TMath::Power(3*TMath::Pi(),-1);
...
double n2func( double x){
  nc++;
  return eta*TMath::Power(TMath::Exp(TMath::Sqrt(TMath::Power(0.01,2)+
...
void integralv5(double a = 0.001, double b = 3.51)
{
  testIntegPerf(a, b);
}
