...
void Plot4(){
  char name[50];
  sprintf(name,"0.20.Au.Au.beta0.15.root");
  ...
  char name1[50];
  sprintf(name1,"20.40.Au.Au.beta0.15.root");
  ...
  char name2[50];
  sprintf(name2,"40.60.Au.Au.beta0.15.root");
  ...
  char name3[50];
  sprintf(name3,"0.40.Cu.Cu.beta0.15.root");
 ...
 while (1) {
  ...
  b0H->GetYaxis()->SetRangeUser(0.00001,20);
