...
void Plotyieldv2(){
  ...
  //  gsT->Draw("integralv2T:omegaT","tT<0.1 && qintT>3");

  FILE *fp = fopen("yield20.40.txt","r");
  Int_t ncols;
  Float_t x,y;
  FILE *fp1 = fopen("v220.40.txt","r");
  ...
  */
  ...
  TCanvas *pt2 = new TCanvas("pt2", "pt2 particles distribution",10,10,700,700);
  gStyle->SetOptStat(false);
  // gStyle->SetOpt2Stat("me");
  gStyle->SetOptTitle(0);
  gStyle->SetPalette(1);
  pt2->SetRightMargin(0.0465116);
  pt2->SetTopMargin(0.39916);
  pt2->SetFillColor(0);
  TPad *pt2_1 = new TPad("pt2_1", "pt2_1",0.0,0.0,0.98,0.98);
  pt2_1->Draw();
  pt2_1->cd();
  pt2_1->Range(-20.6795,-0.0133333,105.496,0.062549);
  pt2_1->SetFillColor(0);
  pt2_1->SetBorderSize(2);
  pt2_1->SetLeftMargin(0.17);
  pt2_1->SetRightMargin(0.05);
  pt2_1->SetTopMargin(0.1);
  pt2_1->SetBottomMargin(0.15);
  pt2_1->SetFrameLineWidth(2);
  pt2_1->SetFrameLineWidth(2);
  //pt2_1->SetLogy();
  //  pt2_1->SetGridy();
  //pt_1->SetGridx();
