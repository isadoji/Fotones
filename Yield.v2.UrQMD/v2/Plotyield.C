...
void Plotyield(){
 ...
 cout << n << endl;
  ...
  yield03H->GetYaxis()->SetTitleOffset(2);
  ...
  */
  ...
  leg2->AddEntry("yield03H","#beta = 0, 40-60 %","p");
  leg2->Draw();
  //  pt->SaveAs("Yield.40.60.beta.0.pdf");
  //pt->SaveAs("Yield.40.60.beta.0.eps");
